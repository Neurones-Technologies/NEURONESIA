 ...
 * prévisionnelle.
 *
 * Le volet transverse « Formation et qualité » a été retiré du cockpit. Son écran
 * reste en place (`./DfFormation`, alimenté par `getFormation`) mais n'est plus
 * monté ici ni déclaré dans `VISION_SECTIONS.df` : les deux doivent revenir
 * ensemble pour le rétablir, sans quoi le menu pointerait dans le vide (ou
 * l'inverse). */
